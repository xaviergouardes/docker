...
$servers->setValue('server','base',array('dc=ma-region,dc=fr'));
...
$servers->setValue('login','bind_id','cn=ldap-manager,dc=ma-region,dc=fr');

/* Your LDAP password. If you specified an empty bind_id above, this MUST also
   be blank. */
// $servers->setValue('login','bind_pass','');
$servers->setValue('login','bind_pass','toto');
